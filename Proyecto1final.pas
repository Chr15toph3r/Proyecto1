                ...
                begin
                    repeat
                            begin
                                ...
                                ClrScr;
                                WriteLn('Nombre ingresado correctamente: ', Nombre); WriteLn;
                            ...
                            begin
                                ...
                                ClrScr;
                                WriteLn('Apellido ingresado correctamente: ', Apellido); WriteLn;
                                WriteLn('Presione cualquier tecla para continuar.');
                                ReadLn;
                                Clrscr;
                            end;                        
                            begin
                                repeat
                                    Write('Por favor escriba su cedula de identidad: ');        
                                    Readln(Cedula);
                                    SoloNumeros := true;
...
if totalpagar>=1 then
    ...
    begin
        if montototal > totalpagar then
        begin
            montoexcedente := montototal - totalpagar;
